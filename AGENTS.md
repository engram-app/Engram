...
- Publishing to the official MCP registry (`server.json`, `mcp-publisher`, GitHub namespace auth), or a re-publish is rejected because `version` was not bumped (hand-synced to `mix.exs`, no CI) → `docs/context/mcp-registry-publishing.md`
