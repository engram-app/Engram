defmodule EngramWeb.CrdtIndexChannelTest do
  ...
  # Index sync is once-per-connect handshake traffic. Billing it to the edit
  # bucket would let index frames starve a user's real edits — the shape behind
  # the 2026-07-07 cross-file-overwrite incident.
  test "index frames are billed to the handshake bucket, not the edit bucket", ctx do
    ...
    # would pass whichever bucket these are billed to. The 2nd and 3rd are what
