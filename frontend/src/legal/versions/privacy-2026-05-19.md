...
| [Fly.io](https://fly.io/legal/privacy-policy) | Application hosting (Phoenix backend at app.engram.page) | All API traffic; encrypted note ciphertext at rest | US (multi-region) | DPF (EU/UK/Swiss) + SCCs |
| [Tigris](https://www.tigrisdata.com/privacy-policy/) | Encrypted attachment object storage (S3-compatible) | Encrypted attachment ciphertext | US | SCCs |
| [Qdrant Cloud](https://qdrant.tech/legal/privacy-policy/) | Vector search index for semantic recall | Quantized embeddings; no plaintext content | US / EU | DPF (EU) + SCCs |
