...
export default function AuthBackdrop() {
	return (
		<div className="pointer-events-none absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
			...
			<div className="neural-glow-purple absolute -top-32 -left-32 size-96 opacity-60" />
			<div className="neural-glow-cyan absolute -right-32 -bottom-32 size-96 opacity-60" />
		</div>
	);
}
