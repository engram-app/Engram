	...
	return (
		<DialogPortal>
			...
			<DialogPrimitive.Content
				...
				className={cn(
					"data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 -translate-1/2 fixed top-1/2 left-1/2 z-50 grid w-full max-w-md gap-4 rounded-lg border bg-popover bg-clip-padding p-6 text-popover-foreground text-sm shadow-lg duration-200 data-closed:animate-out data-open:animate-in",
					className,
				)}
				{...props}
			>
