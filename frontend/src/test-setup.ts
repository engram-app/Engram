...
// Guarded: worker/index.test.ts opts into `@vitest-environment node` (real
// fetch/Request/Headers, unlike happy-dom, which silently drops forbidden
// "Sec-*" request headers) and has no HTMLElement at all.
