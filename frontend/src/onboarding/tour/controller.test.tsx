...
describe('TourController', () => {
  it('mounts Joyride with run=true when active', () => {
    ...
    renderWithRouter(<TourController active onExit={() => {}} reachedEnd={false} setReachedEnd={() => {}} />)
  ...
  it('mounts Joyride with run=false when inactive', () => {
    joyrideMock.mockClear()
    renderWithRouter(<TourController active={false} onExit={() => {}} reachedEnd={false} setReachedEnd={() => {}} />)
    const call = joyrideMock.mock.calls[0]?.[0]
